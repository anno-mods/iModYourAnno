...
namespace Imya.GithubIntegration.StaticData
{
    public class StaticRepoInfoSource : IRepoInfoSource
    {
        ...
        private GithubRepoInfo[] Repositories = {
            ...
            StaticNameGithubRepoInfoFactory.CreateWithStaticName("anno-1800-jakobs-mods", "jakobharder", "Jakobs-Collection-v*.zip"),
            StaticNameGithubRepoInfoFactory.CreateWithStaticName("WholesomeHaciendaHaul", "Taludas", "TheWholesomeHaciendaHaul_v*.zip"),
            StaticNameGithubRepoInfoFactory.CreateWithStaticName("SmallModsCollection", "Taludas", "SmallModsCollection_v*.zip"),
